...
if __name__ == '__main__':
    ...
    if FLOW_TRAINING:
        ...
        checkpoint_save_path = 'model/i3d/flow_checkpoint_whole.pt'
        ...
        checkpoint_save_path = 'model/i3d/rgb_checkpoint_whole.pt'
    ...
    if FLOW_TRAINING:
        model = nn.DataParallel(InceptionI3d().to(device=DEVICE))
    else:
        model = nn.DataParallel(InceptionI3d().to(device=DEVICE))
    model.train()
